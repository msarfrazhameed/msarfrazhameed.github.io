---
title: "Enterprise Healthcare Network Architecture"
date: 2026-04-26
draft: false
tags: ["Networking", "Cybersecurity", "Cisco", "OSPF", "Zero-Trust"]
summary: "Architected a highly secure, multi-area OSPF network for a healthcare facility featuring VLAN segregation, strict ACLs, and a NAT-secured Server Farm."
layout: "hero"
---

{{< button href="https://github.com/msarfrazhameed/enterprise-healthcare-network" target="_blank" >}}
<span class="flex items-center gap-2">
  ...
  View Source Code & Configs on GitHub
</span>
{{< /button >}}
...
* **Access Control:** Deployed targeted ACLs to restrict web-service access from unauthorized zones.